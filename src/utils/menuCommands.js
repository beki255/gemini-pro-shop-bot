...
const commands = {
  ...
  admin: {
    am: [
      ...
      { command: 'checkouts', description: '💳 በክፍያ ላይ ያሉ (Checkouts)' },
      { command: 'users', description: '👥 የተመዘገቡ ተጠቃሚዎች' },
    ...
    en: [
      ...
      { command: 'checkouts', description: '💳 Active Checkouts' },
      { command: 'users', description: '👥 Registered Users' },
